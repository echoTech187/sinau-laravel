                            ...
                            <div class="form-control w-full">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model="form.base_price"
                                        class="input input-bordered w-full pl-12 bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all font-bold @error('form.base_price') border-red-500 @enderror" />
                                </div>
