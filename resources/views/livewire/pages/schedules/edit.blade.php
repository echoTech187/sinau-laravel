@php /** @var \App\Livewire\Pages\Schedules\Edit $this */ @endphp
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                            <div class="form-control w-full">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model="form.base_price"
                                        class="input input-bordered w-full pl-12 bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all font-bold @error('form.base_price')  @enderror" />
                                </div>
                            ...
                            <div class="form-control w-full">
                                <label class="label pb-0"><span
                                        class="label-text text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1.5">Status
                                        Jadwal*</span></label>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white/60 dark:bg-zinc-900/40 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm animate-fade-in-up"
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-[10px] text-zinc-400 text-center px-2">Data Anda akan segera di-update ke
                                seluruh sistem monitoring armada.</p>
                        </div>
                    </div>
                </div>
            </div>
