@php
    /** @var \App\Livewire\Pages\Agents\Edit $this */
@endphp
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" wire:model="form.agent_code"
                                class="input input-bordered uppercase bg-slate-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm font-bold placeholder:font-normal placeholder:lowercase opacity-60 cursor-not-allowed"
