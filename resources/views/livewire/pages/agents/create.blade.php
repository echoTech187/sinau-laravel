                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-control w-full">
                                ...
                                <input type="text" wire:model="form.agent_code"
                                    class="input input-bordered uppercase bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all font-bold placeholder:font-normal placeholder:lowercase"
                                    placeholder="AGT-001" />
