        ...
        <form id="routeForm" wire:submit="saveRoute" class="space-y-6">
            ...
            <div class="bg-white/60 dark:bg-zinc-900/40 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 md:p-8 shadow-sm animate-fade-in-up"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <x-form-input label="Kode Operasional Tanda Rute*" wire:model="form.route_code"
                        placeholder="RUT-SBY-MLG" class="uppercase" />
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-zinc-400 mt-1">Tambahkan agen, rest area, atau pool cabang
                                    yang di
                                    lewati oleh Rute Utama di atas secara berurutan.</p>
                            </div>
                            <button type="button" wire:click="addStop"
                                class="btn btn-sm bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-indigo-600 dark:text-indigo-400 border-0 rounded-lg shrink-0">
                        ...
                        <div class="space-y-4">
                            ...
                            @else
                                <div
                                    ...
                                    <p class="text-xs text-zinc-400 dark:text-zinc-500 mt-1">Rute ini dianggap sebagai
                                        Rute
                                        Langganan Cepat (Point-to-Point) antara Asal -> Tujuan tanpa melalui terminal
                                        agen
                                        lain.
                                    </p>
                                </div>
                        ...
                        <div class="mt-5">
                            <button type="submit"
                                ...
                                <span class="flex items-center justify-center gap-2 relative z-10">
                                    <x-heroicon-o-check-circle wire:loading.remove wire:target="saveRoute"
                                        class="w-5 h-5" />
