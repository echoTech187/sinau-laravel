@php /** @var \App\Livewire\Pages\Routes\Create $this */ @endphp
            ...
            <header
                ...
                <div>
                    ...
                    <p class="mt-3 text-sm text-zinc-500 dark:text-zinc-400">
                        Pastikan Anda menentukan Terminal Asal dan Tujuan Utama sebelum menyisipkan detail titik
                        Drop-off / Boarding sub-rute.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" wire:model="form.route_code"
                            class="input input-bordered uppercase bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all @error('form.route_code')  @enderror"
                            placeholder="RUT-SBY-MLG" />
                        @error('form.route_code')
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" wire:model="form.name"
                            class="input input-bordered bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all @error('form.name')  @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        <select wire:model="form.destination_location_id"
                            class="select select-bordered bg-white dark:bg-zinc-950 border-red-200 dark:border-red-900/50 rounded-xl shadow-sm focus:ring-2 focus:ring-red-500 transition-all @error('form.destination_location_id')  @enderror">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="number" wire:model="form.distance_km"
                            class="input input-bordered bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all @error('form.distance_km')  @enderror"
                            placeholder="Cth: 155" />
            ...
            <div class="bg-white/60 dark:bg-zinc-900/40 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 md:p-8 shadow-sm animate-fade-in-up"
                ...
                <div class="flex items-center justify-between mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-800">
                    <div>
                        ...
                        <p class="text-[10px] text-zinc-400 mt-1">Tambahkan agen, rest area, atau pool cabang yang di
                            lewati oleh Rute Utama di atas secara berurutan.</p>
                    </div>
                    <button type="button" wire:click="addStop"
                        class="btn btn-sm bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-indigo-600 dark:text-indigo-400 border-0 rounded-lg">
                        <x-heroicon-o-plus class="w-4 h-4" /> Tambah Titik Stop
                    </button>
                </div>
                            ...
                            <div wire:key="stop-{{ $index }}"
                                ...
                                <div class="w-full md:flex-1">
                                    ...
                                    <select wire:model="form.stops.{{ $index }}.location_id"
                                        class="select select-bordered select-sm w-full bg-white dark:bg-zinc-900 @error('form.stops.' . $index . '.location_id')  @enderror">
                                ...
                                <div class="w-full md:w-48 shrink-0">
                                    ...
                                    <select wire:model="form.stops.{{ $index }}.type"
                                        class="select select-bordered select-sm w-full bg-white dark:bg-zinc-900 @error('form.stops.' . $index . '.type')  @enderror">
