            ...
            <header
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white flex items-center gap-3">
                        ...
                        Tambah Data Kru (Awak Bus)
                    </h1>
                    <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                        Lengkapi informasi detail awak bus operasional baru.
                    </p>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-8">
                        <div class="relative group">
                            ...
                            <label
                                class="absolute -bottom-3 -right-3 p-3 rounded-2xl bg-white dark:bg-zinc-800 shadow-lg border border-zinc-100 dark:border-zinc-700 cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all active:scale-95 group-hover:shadow-indigo-500/20">
                                <x-heroicon-o-camera class="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                        ...
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1 max-w-sm">Gunakan foto formal dengan
                                seragam perusahaan. Maksimum 2MB (JPG, PNG).</p>
                            @error('form.photo')
                ...
                <div
                    ...
                    <div class="flex items-center gap-4 w-full sm:w-auto">
                        <button type="button" wire:click="$refresh"
                            class="btn btn-ghost rounded-2xl text-zinc-500 hover:text-zinc-800 dark:hover:text-white transition-all text-[11px] font-black uppercase tracking-widest">
                            Reset Form
                        </button>
