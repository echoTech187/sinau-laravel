<div class="container relative min-h-screen pb-10">
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div
            class="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-amber-500/10 dark:bg-amber-500/5 rounded-full blur-[100px]">
        </div>
    </div>
            ...
            <header
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white flex items-center gap-3">
                        <div
                            class="p-2.5 rounded-2xl bg-gradient-to-br from-emerald-500 to-amber-600 shadow-lg shadow-emerald-500/30">
                            <x-heroicon-o-pencil-square class="w-6 h-6 text-white" />
                        </div>
                        Ubah Data Kru: {{ $crew->name }}
                    </h1>
                    <p class="mt-3 text-sm text-zinc-500 dark:text-zinc-400">
                        Perbarui perizinan, posisi rotasi, atau status operasional.
                    </p>
                </div>
