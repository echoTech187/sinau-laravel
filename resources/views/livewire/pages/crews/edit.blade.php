@php /** @var \App\Livewire\Pages\Crews\Edit $this */ @endphp
            ...
            <header
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white flex items-center gap-3">
                        <div
                            class="p-2.5 rounded-2xl bg-linear-to-br from-emerald-500 to-amber-600 shadow-lg shadow-emerald-500/30">
