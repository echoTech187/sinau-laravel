@php
    /** @var \App\Livewire\Pages\Buses\Create $this */
@endphp
            ...
            <form id="busForm" wire:submit="saveBus" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        <x-form-file label="Upload Foto Bus" wire:model="form.photo"
                            hint="Format: JPG, PNG. Maks: 2MB. Foto akan ditampilkan di daftar armada." />
                            ...
                            <div
                                ...
                                @else
                                    <div class="text-center p-6">
                                        ...
                                        <p class="text-xs text-zinc-400">Belum ada foto dipilih</p>
                                    </div>
                                @endif
