<div class="container relative min-h-screen pb-10">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[100px]"></div>
    </div>
        ...
        <header
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white flex items-center gap-3">
                    <div
                        class="p-2.5 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 shadow-lg shadow-indigo-500/20 text-white">
