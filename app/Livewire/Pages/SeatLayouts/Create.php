...
class Create extends Component
{
    ...
    {
        $this->tempRows = $this->form->decks[$this->activeDeckIndex]['rows'];
        $this->tempCols = $this->form->decks[$this->activeDeckIndex]['cols'];
    }
    ...
    {
        // Regenerate grid if rows/cols of active deck changed
        $this->generateGrid($this->activeDeckIndex);
    }
