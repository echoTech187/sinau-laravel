...
class Create extends Component
{
     ...
     * Uses Haversine × 1.35 road multiplier.
     */
    ...
    /**
     * Returns an ordered array of route segments for the preview card.
     * Each entry: ['name', 'label', 'km' (from prev node), 'type']
     */
    #[Computed]
    ...
    public function saveRoute()
    {
        try {
            $this->form->store();
            $this->dispatch('notify', ['type' => 'success', 'title' => 'Berhasil', 'message' => 'Rute operasional baru berhasil disimpan.']);
